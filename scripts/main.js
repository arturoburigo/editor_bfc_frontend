document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .querySelector(".tab-actions button:first-child")
  ...
  // -----------------------------
  // JS para integração do Chat AI
  // -----------------------------
  const chatIcon = document.getElementById("chat-ai");
  ...
  function sendUserMessage() {
    ...
    if (message) {
      ...
      // Aqui, apenas simulamos uma resposta com um atraso
      // TODO Integrar com a API de IA => Pegamos a mensagem do usuário, enviamos através da integração e recebemos a resposta
      setTimeout(() => {
        const responses = [
          "Entendi! Como posso ajudar com isso?",
          "Obrigado por sua mensagem! Vou analisar isso.",
